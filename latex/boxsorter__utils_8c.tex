...
Gráfico de dependencias incluidas en boxsorter\+\_\+utils.\+c\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{boxsorter__utils_8c__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Inicializa el detector ultras�nico. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Inicializa las salidas del sistema de clasificaci�n. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Clasifica una caja en funci�n de su altura medida. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Funci�n placeholder para futuras tareas relacionadas con los servos. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{center}
\leavevmode
\includegraphics[width=346pt]{boxsorter__utils_8c_a4562adac5d13f7b61b8bfa840df39e58_icgraph}
\end{center}
\end{figure}
...
Inicializa el detector ultras�nico. 

Configura el puntero al sensor ultras�nico y al sensor IR asociado.


\begin{DoxyParams}[1]{Parámetros}
\mbox{\texttt{ out}}  & {\em hcsr04\+Detector} & Estructura del detector ultras�nico. \\
\hline
\mbox{\texttt{ in}}  & {\em sensor\+\_\+ultra} & Puntero al sensor ultras�nico. \\
\hline
...
\begin{center}
\leavevmode
\includegraphics[width=219pt]{boxsorter__utils_8c_a17f05d303b2b8f8241647d984b12a97e_icgraph}
\end{center}
\end{figure}
...
Inicializa las salidas del sistema de clasificaci�n. 

Carga configuraci�n desde EEPROM si existe, o aplica valores por defecto. Asocia pines y marca todas las salidas como listas (READY). Gráfico de llamadas de esta función\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{boxsorter__utils_8c_ac3988d0a14e12e52073709af9b93fe9d_cgraph}
\end{center}
\end{figure}
Gráfico de llamadas a esta función\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=216pt]{boxsorter__utils_8c_ac3988d0a14e12e52073709af9b93fe9d_icgraph}
\end{center}
\end{figure}
\index{boxsorter\_utils.c@{boxsorter\_utils.c}!initServos@{initServos}}
...
Asigna �ngulo inicial y pines de control. Los servos son almacenados en un arreglo global. Gráfico de llamadas de esta función\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{boxsorter__utils_8c_ad978a60fb09963ff64dba6092ee48c2f_cgraph}
\end{center}
\end{figure}
Gráfico de llamadas a esta función\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=312pt]{boxsorter__utils_8c_ad978a60fb09963ff64dba6092ee48c2f_icgraph}
\end{center}
\end{figure}
\index{boxsorter\_utils.c@{boxsorter\_utils.c}!initSorter@{initSorter}}
...
\begin{center}
\leavevmode
\includegraphics[width=208pt]{boxsorter__utils_8c_aa3c646ee656c4a2b207ebb0779a3693b_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{boxsorter__utils_8c_a4f7cf5974fc873b6a0036fb285e6189c_cgraph}
\end{center}
\end{figure}
Gráfico de llamadas a esta función\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=231pt]{boxsorter__utils_8c_a4f7cf5974fc873b6a0036fb285e6189c_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=219pt]{boxsorter__utils_8c_a8e5960349b41ab72dbc29f06048d8145_icgraph}
\end{center}
\end{figure}
\index{boxsorter\_utils.c@{boxsorter\_utils.c}!ultraSensorTask@{ultraSensorTask}}
...
\begin{center}
\leavevmode
\includegraphics[width=273pt]{boxsorter__utils_8c_af0e381d6f0d88428934b9854cddb037f_cgraph}
\end{center}
\end{figure}
Gráfico de llamadas a esta función\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=240pt]{boxsorter__utils_8c_af0e381d6f0d88428934b9854cddb037f_icgraph}
\end{center}
\end{figure}
