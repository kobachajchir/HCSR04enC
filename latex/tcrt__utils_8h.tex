...
Gráfico de dependencias incluidas en tcrt\+\_\+utils.\+h\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=252pt]{tcrt__utils_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Inicializa los sensores TCRT conectados a los pines anal�gicos. \end{DoxyCompactList}\item 
...
\begin{center}
\leavevmode
\includegraphics[width=303pt]{tcrt__utils_8h_ae09ff4102347ab8d40f5b4fc600e67ca_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{tcrt__utils_8h_ae09ff4102347ab8d40f5b4fc600e67ca_icgraph}
\end{center}
\end{figure}
...
Inicializa los sensores TCRT conectados a los pines anal�gicos. 

Configura los pines PC0�\+PC3 como entradas, desactiva pull-\/ups, y configura el ADC para su uso. Gráfico de llamadas a esta función\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=313pt]{tcrt__utils_8h_a640932133dbc070f018c88daa1988cde_icgraph}
\end{center}
\end{figure}
\index{tcrt\_utils.h@{tcrt\_utils.h}!tcrt\_is\_box\_detected@{tcrt\_is\_box\_detected}}
...
Utiliza el valor de umbral ajustado con hist�resis para detectar presencia de objetos. Tambi�n detecta flancos de subida/bajada y actualiza el estado del sensor.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{tcrt__utils_8h_ab6c59b4ce307ce1bbe252421d22d06ae_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=264pt]{tcrt__utils_8h_a088ecc5d18c61778d47fbcfa19746250_cgraph}
\end{center}
\end{figure}
Gráfico de llamadas a esta función\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=322pt]{tcrt__utils_8h_a088ecc5d18c61778d47fbcfa19746250_icgraph}
\end{center}
\end{figure}
...
\begin{DoxyRetVals}{Valores devueltos}
{\em Valor} & de 10 bits de la conversi�n ADC (0�1023). \\
\hline
\end{DoxyRetVals}
Gráfico de llamadas a esta función\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{tcrt__utils_8h_a6a9f4f05c2e44d7839a90a16a7bf5874_icgraph}
\end{center}
\end{figure}
