...
Borra todos los campos del {\ttfamily receive\+Pck} para permitir recibir un nuevo paquete. \index{protocol\_utils.c@{protocol\_utils.c}!create\_payload@{create\_payload}}
...
\begin{DoxyRetVals}{Valores devueltos}
{\em \doxyref{Command}{pÃ¡g.}{protocol_types_8h_a2afce0a47a93eee73a314d53e4890153}} & Comando de respuesta correspondiente. \\
\hline
\end{DoxyRetVals}
